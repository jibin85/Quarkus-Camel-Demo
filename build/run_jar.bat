...
CD /D "%CD%\quarkus-swagger-integration\target" || (
    echo Error: Failed to change directory to quarkus-swagger-integration/target
    exit /b 1
)
...
if not exist "%quarkus-swagger-integration%\quarkus-app\quarkus-run.jar" (
    echo Error: JAR file not found: %quarkus-swagger-integration%\quarkus-app\quarkus-run.jar
    exit /b 1
)
